...
float radius_limit_max = 0.01;
float radius_limit_min = 0.005;
...
cloud_cb (const pcl::PointCloud<pcl::PointXYZ>::ConstPtr& cloud)
{
  ...
  seg.setRadiusLimits (radius_limit_min, radius_limit_max);
...
main (int argc, char** argv)
{
  ...
  pnh.getParam("radius_limit_max", radius_limit_max);
  pnh.getParam("radius_limit_min", radius_limit_min);
